...
The ratios of predicted over observed mean AUC or CL values from all compounds were also plotted across all age groups in the figure below. As illustrated, most of the predictions were within the 0.5 to 2.0 range (2-fold error). 
